classdef CartPolePlant < Manipulator
  ...
  properties
    ...
    mp = 10;    % mass of the pole (point mass at the end) in kg
  ...
  methods
    function obj = CartPolePlant
      ...
      %obj.xG2 = Point(obj.getStateFrame,[0;pi;0;0]);
  ...
  methods
    ...
    function [utraj,xtraj]=swingUpTrajectory(obj)
      ...
      N = 21; % This controls the number of time samples (knot points) used
